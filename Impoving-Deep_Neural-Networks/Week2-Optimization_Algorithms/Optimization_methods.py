...
# Advaned optimization methods to speed up learning 
...
# Momentum - reduces the 'oscillation' during mini-batch gradient descent convergence
...
# Build model with different optimization algorithm
